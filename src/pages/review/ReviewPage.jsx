...
const ReviewPage = () => {
  ...
  const [hideRevies, SetHideReview] = useState(true);
            ...
            "
                >
                  ...
                  <div className="flex flex-col">
                    ...
                    ></textarea>
                    <small className="text-muted-foreground">
                      Describe what you liked, what you didn't like and other
                      key things shoppers should know. Minimum 30 characters.
                    </small>
                  </div>
                  <div className="flex flex-col">
                    <label>
